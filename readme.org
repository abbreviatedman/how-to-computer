...
#+name: gsetq
#+begin_src emacs-lisp
  (defvaralias 'gsetq 'general-setq)
#+end_src
...
#+BEGIN_SRC emacs-lisp
  (use-package emacs
    :init
    (general-setq project-switch-commands 'project-find-file)
    :general
...
#+BEGIN_SRC emacs-lisp
  ...
  (general-setq use-package-always-ensure t)
  ...
  (use-package auto-package-update
    ...
    :config
    (general-setq auto-package-update-delete-old-versions t)
    (general-setq auto-package-update-hide-results t)
...
#+BEGIN_SRC emacs-lisp
  (use-package emacs
    :init
    (general-setq custom-file "~/.emacs.d/emacs-custom-file.el")
...
#+NAME: color-theme
#+BEGIN_SRC emacs-lisp
  (general-setq modus-themes-italic-constructs t
...
#+BEGIN_SRC emacs-lisp
  (recentf-mode 1)
  (general-setq history-length 100)
  (savehist-mode 1)
#+END_SRC
