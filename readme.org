...
#+BEGIN_SRC emacs-lisp
  (use-package emacs
    :init
    (gsetq project-switch-commands 'project-find-file)
    :general
...
#+BEGIN_SRC emacs-lisp
  ...
  (gsetq use-package-always-ensure t)
  ...
  (use-package auto-package-update
    ...
    :config
    (gsetq auto-package-update-delete-old-versions t)
    (gsetq auto-package-update-hide-results t)
...
#+BEGIN_SRC emacs-lisp
  (use-package emacs
    :init
    (gsetq custom-file "~/.emacs.d/emacs-custom-file.el")
...
#+NAME: color-theme
#+BEGIN_SRC emacs-lisp
  (gsetq modus-themes-italic-constructs t
