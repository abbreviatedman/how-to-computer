...
Go to [[Debian Linux's website][http://www.debian.org]], download the installation disk, copy it to a flash drive, insert it into your computer, and boot up from it. Then follow the graphical installer's directions.
